      ...
      <div className="parent-cont">
        ...
        <div className="main-cont">
          <div className="cont-1">
            <Link to="/home">
              <Tag icon="./emojis/home.svg" text="Home" />
            </Link>
            <Link to="/performance">
              <Tag icon="./emojis/performance.svg" text="Performance" />
            </Link>
            <Link to="/cpu">
              <Tag icon="./emojis/CPU.svg" text="CPU" />
            </Link>
            <Link to="/thermals">
              <Tag icon="./emojis/thermals.svg" text="Thermals" />
            </Link>
            <Link to="/ai">
              <Tag icon="./emojis/AI.svg" text="AI" />
            </Link>
            <Link to="/help">
              <Tag icon="./emojis/help.svg" text="Help" />
            </Link>
          </div>
